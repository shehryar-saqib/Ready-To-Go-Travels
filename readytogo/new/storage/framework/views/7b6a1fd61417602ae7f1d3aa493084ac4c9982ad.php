...
<body>
   ...
   <?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="d-flex align-items-center justify-content-center" style="background-image: url(assets/img/packageDeet/naran.jpeg);">
        <div class="container" data-aos="fade-up">

            <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="150">
                <div class="col-xl-6 col-lg-8">
                    <h1>Naran Kaghan<br> 3 Days – 2 Nights Tour Package</h1>
        ...
        <div id="page_content_wrapper" class="hasbg withtopbar ">
                ...
                <div class="inner_wrapper">
                    ...
                    <div class="sidebar_content ">
                        ...
                        <div class="single_tour_content">
                            ...
                            <h4>Day-1</h4>
                            <ul style="margin-left: 70px;">Islamabad to Kaghan and then Naran</ul>
                            <ul style="margin-left: 70px;">Stay at Naran</ul>
                            <h4>Day-2</h4>
                            <ul style="margin-left: 70px;">Naran to Babusar Top and then Saif-ul-Mulook Lake</ul>
                            <ul style="margin-left: 70px;">Stay at Naran</ul>
                            <h4>Day-3</h4>
                            <p style="margin-left: 100px;">Naran to Islamabad</p>
            ...
            <div class="container" data-aos="zoom-in">
                <div class="text-center">
                    ...
                    <button style="background-color:lightgreen; width: 200px; border-radius:20px; padding: 10px;"> <a href="<?php echo e(route('bookings', ['place'=>'Naran','price'=>12000,'d_date'=>'2022-12-28','r_date'=>'2022-12-31','is_customized'=>false])); ?>">Book Now</a></button>
                </div>
...
<?php /**PATH C:\Users\cw\new\resources\views/Naran.blade.php ENDPATH**/ ?>