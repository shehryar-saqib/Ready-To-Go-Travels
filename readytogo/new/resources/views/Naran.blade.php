        ...
        <div id="page_content_wrapper" class="hasbg withtopbar ">
            ...
            <div class="container" data-aos="zoom-in">
                <div class="text-center">
                    ...
                    <button style="background-color:lightgreen; width: 200px; border-radius:20px; padding: 10px;"> <a href="{{route('bookings', ['place'=>'Naran','price'=>12000,'d_date'=>'2022-12-28','r_date'=>'2022-12-31','is_customized'=>false])}}">Book Now</a></button>
                </div>
