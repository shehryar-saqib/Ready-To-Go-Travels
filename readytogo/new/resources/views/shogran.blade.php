        ...
        <div id="page_content_wrapper" class="hasbg withtopbar ">
            ...
            <div class="container" data-aos="zoom-in">
                <div class="text-center">
                    ...
                    <button style="background-color:lightgreen; width: 200px; border-radius:20px; padding: 10px;"> <a href="{{route('bookings', ['place'=>'Shogran','price'=>16500,'d_date'=>'2022-12-10','r_date'=>'2022-12-13','is_customized'=>false])}}">Book Now</a></button>
                </div>
