  ...
  <div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-8 order-md-1">
            ...
            <form method="post" action="{{ route('bookings',['place'=>$place,'price'=>$price,'is_customized'=>$is_customized]) }}">
                @csrf
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="d_date">Departure Date</label>
                        <input type="date" class="form-control" id="d_date" name="d_date" value="{{$d_date}}" readonly   required=""> 
                        <div class="invalid-feedback"> Please select a valid date. </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label for="r_date">Return Date</label>
                        <input type="date" class="form-control" id="r_date" name="r_date"  value="{{$r_date}}" readonly required=""> 
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" value="{{Auth::user()->email}}" readonly required autocomplete="email" autofocus>
